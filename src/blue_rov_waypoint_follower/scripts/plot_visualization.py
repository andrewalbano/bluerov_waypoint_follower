...
if __name__ =='__main__':
    # initialize node
    rospy.init_node("plot_viusalizer")
    rospy.loginfo("plot_viusalizer node has been started.")

    sub2 = rospy.Subscriber("waypoint_plot_viualization", PoseArray, callback= get_waypoints_callback)
